...
public class SipLayerFacade implements SipListener {
	...
	public SipLayerFacade(String username, String ip, int port)
	...
	public void processRequest(RequestEvent evt) {
		...
		sipMessageListener.processReceivedMessage(from.getAddress().toString(), new String(req.getRawContent()));
